...
{
     GameObject player; //Reference to the player so we can track its postiton
     ...
     void Update()
     {
         ...
         //^^^^^^^^^^^^^^^^^^^This linesets our texture `offset`. we use the
         ...
         //The second parameter is a Vecotr2, with the first (X) variable shifting the texture
